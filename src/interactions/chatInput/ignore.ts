...
import { SlashCommandBuilder, PermissionFlagsBits, EmbedBuilder, GuildChannel } from 'discord.js'
    ...
    super(IgnoreScb,
      async (int, client) => {
        ...
        if (subcommandName === 'list') {
          const IgnoreListEmbed = new EmbedBuilder({
        ...
        if (subcommandName === 'add') {
          ...
          if (userData === null) {
            ...
            if (guildChannels === undefined) {
              ...
              if (channel instanceof GuildChannel && guildChannels.channelIDs.some(s => s === channel.parentId)) {
          ...
          const IgnoreAddEmbed = new EmbedBuilder({
        ...
        if (subcommandName === 'remove') {
          ...
          const IgnoreRemoveEmbed = new EmbedBuilder({
